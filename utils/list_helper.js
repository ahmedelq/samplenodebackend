...
const favoriteBlog = (blogs) => blogs.sort((b1, b2) => b1.likes - b2.likes).pop();
...
const mostLikes = (blogs) => {
  ...
  return _.map(likeCounts, (val, key) => 
    ({ author: key, likes: val.reduce((acc, b) => acc + b.likes, 0) }))
    .sort((a, b) => a.likes - b.likes).pop();
};
module.exports = {
  palindrome, avg, dummy, totalLikes, favoriteBlog, mostBlogs, mostLikes,
};
